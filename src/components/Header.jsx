...
const navItems = [
  ...
  { name: "Experience", path: "/experience" }, // Placeholder if needed
        ...
        <nav className="lg:flex hidden space-x-8">
          {navItems.map((item, index) => (
            ...
            >
              <Link
                to={item.path}
                className={`text-gray-800 dark:text-gray-200 font-medium transition-colors duration-300 ${
                  pathname === item.path ? "text-violet-600 dark:text-violet-400" : "hover:text-violet-600 dark:hover:text-violet-400"
                }`}
              >
                {item.name}
